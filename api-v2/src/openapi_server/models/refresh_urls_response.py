...
class RefreshUrlsResponse(BaseModel):
    ...
    status_message: StrictStr = Field(description="Status message")
    updated_count: Optional[StrictInt] = Field(default=None, description="Number of videos updated")
    __properties: ClassVar[List[str]] = ["status_code", "status_message", "updated_count"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RefreshUrlsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RefreshUrlsResponse from a dict"""
        if obj is None:
            return None
