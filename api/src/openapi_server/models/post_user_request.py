...
class PostUserRequest(BaseModel):
    ...
    nickname: Annotated[str, Field(strict=True)] = Field(description="ニックネーム")
    icon_url: Annotated[str, Field(strict=True)] = Field(description="アイコン画像のURL")
    __properties: ClassVar[List[str]] = ["google_id", "nickname", "icon_url"]
